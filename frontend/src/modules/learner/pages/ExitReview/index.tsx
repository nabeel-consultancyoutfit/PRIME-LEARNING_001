/**
 * Exit Review and Programme Evaluation
 * Pixel-perfect to Figma node 40000068:37960
 */
...
const ROWS = [
  { id: 1, formName: 'Learner feedback from teach sessions', learner: 'John Doe', instance: 'John doe - Exit review and Programme Evaluation - 11/02/2025', created: '07/02/25 08:15', modified: '08/02/25 18:15' },
  { id: 2, formName: 'Learner feedback from teach sessions', learner: 'John Doe', instance: 'John doe - Exit review and Programme Evaluation - 11/02/2025', created: '07/02/25 08:15', modified: '08/02/25 18:15' },
  { id: 3, formName: 'Learner feedback from teach sessions', learner: 'John Doe', instance: 'John doe - Exit review and Programme Evaluation - 11/02/2025', created: '07/02/25 08:15', modified: '08/02/25 18:15' },
  { id: 4, formName: 'Learner feedback from teach sessions', learner: 'John Doe', instance: 'John doe - Exit review and Programme Evaluation - 11/02/2025', created: '07/02/25 08:15', modified: '08/02/25 18:15' },
];

/* ─── Component ─── */

const ExitReview: React.FC = () => {
  const router = useRouter();
  const [dateFrom, setDateFrom] = useState('2025-12-12');
  const [dateTo, setDateTo] = useState('2025-12-18');

  return (
    <LearnerLayout pageTitle="Exit Review">
      <PageWrapper>
        <PageHeader>
          <BackButton onClick={() => router.back()}>
            <ArrowBackIos sx={{ fontSize: '12px', color: '#fff', ml: '4px' }} />
          </BackButton>
          <PageTitle>Exit review and Programme Evaluation</PageTitle>
        </PageHeader>
