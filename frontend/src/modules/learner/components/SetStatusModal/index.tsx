...
/** The modal card — 496×auto, white, rounded 12px, shadow */
...
/** MUI Switch styled to match the Figma green toggle */
...
/** Single checkbox row: custom checkbox square + label */
...
const PillButton = styled(Box)<{ variant?: 'outline' }>(({ variant }) => ({
...
const SetStatusModal: React.FC<SetStatusModalProps> = ({ open, onClose }) => {
  ...
  const handleSave = () => {
    // In a real app, persist status here
    onClose();
  };
        ...
        <ModalCard onClick={(e) => e.stopPropagation()}>
          ...
          <ModalBody>
            <InnerContent>
              ...
              {/* Status checkboxes (radio behavior — single select) */}
              <OptionsWrapper>
            ...
            <ButtonsRow>
              ...
              <PillButton onClick={onClose}>Cancle</PillButton>
            </ButtonsRow>
          </ModalBody>
