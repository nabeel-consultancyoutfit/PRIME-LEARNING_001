...
import { messagesService, Conversation, Message } from '@/modules/trainer/services/messages.service';
            ...
            <>
              ...
              <MessageList ref={messageListRef}>
                ...
                {localMessages.map((msg) => (
                  <MessageBubble key={msg.id} isFromMe={msg.isFromTrainer}>
                    <BubbleContent isFromMe={msg.isFromTrainer}>
                      {msg.content}
                      <BubbleTime isFromMe={msg.isFromTrainer}>
                        {msg.timestamp}
                      </BubbleTime>
                    </BubbleContent>
                  </MessageBubble>
